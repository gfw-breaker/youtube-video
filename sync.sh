...
<div>🔊 希望之声广播：<a href='http://$data_server:8204/soh-live' target='_blank'>中国广播台</a>&nbsp; |&nbsp; <a href='http://$data_server:8204/bayvoice' target='_blank'> 美国联播台</a>&nbsp; |&nbsp; <a href='http://$data_server:8204/SYDNEY' target='_blank'>澳洲台</a>&nbsp; |&nbsp; <a href='http://$data_server:8204/SF969' target='_blank'>粤语台</a></div>
EOF
